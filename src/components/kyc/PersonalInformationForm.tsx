			...
			<Card className="bg-white border-gray-200">
				<CardHeader>
					...
					<CardDescription className="text-gray-600">
						Enter your official government-issued identification
						information
					</CardDescription>
				</CardHeader>
				<CardContent>
					<form onSubmit={handleSubmit} className="space-y-6">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 gap-6">
							<div className="space-y-2">
								...
								<Select
									...
									onValueChange={(
										value: PersonalInfoData["documentType"]
									) =>
						...
						<div className="space-y-2">
							...
							<p className="text-gray-500 text-xs">
								This helps us verify your location more
								accurately
							</p>
						</div>
						...
						<Alert className="bg-blue-50 border-blue-200">
							...
							<AlertDescription className="text-blue-800 text-sm">
								Your information is protected by bank-level
								security and will only be used for verification
								purposes. We comply with all data protection
								regulations.
							</AlertDescription>
						</Alert>
