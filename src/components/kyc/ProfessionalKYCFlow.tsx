...
export const ProfessionalKYCFlow = () => {
	...
	const [currentStep, setCurrentStep] =
		useState<ProfessionalKYCStep>("welcome");
	...
	const steps = [
		{
			key: "welcome",
			title: "Welcome",
			description: "Get started with verification",
			icon: Shield,
		},
		{
			key: "terms",
	...
	const submitVerification = async () => {
		...
		try {
			...
			const requestBody = {
				verification_type: mapDocumentTypeToBackend(
					verificationData.personalInfo.documentType
				),
				...
				nearest_landmark:
					verificationData.personalInfo.nearestLandmark || "",
			};
			...
			const response = await fetch(
				"https://verinest.up.railway.app/api/verification/document",
				{
					method: "POST",
					headers: {
			...
			if (response.ok) {
				...
				toast.success(
					"Professional verification submitted successfully!"
				);
				setCurrentStep("complete");
					...
					<Card className="bg-gradient-to-br from-blue-50 to-indigo-100 border-0 shadow-xl">
						<CardHeader className="text-center pb-8">
							...
							<CardDescription className="text-lg text-gray-600 max-w-2xl mx-auto">
								Secure your account with our enterprise-grade
								verification process. This ensures trust and
								security for all platform participants.
							</CardDescription>
						</CardHeader>
						...
						<CardContent className="space-y-6">
							...
							<div className="space-y-4">
								...
								<div className="grid md:grid-cols-2 gap-4 text-sm">
									...
									<div>
										...
										<p className="text-gray-900">
											{verificationData.personalInfo.lga}
										</p>
									</div>
									<div>
										<span className="font-medium text-gray-500">
							...
							<div className="grid md:grid-cols-2 gap-6">
								<div className="space-y-4">
									...
									<p className="text-sm text-gray-600">
										Professional document scan completed
									</p>
								</div>
								...
								<div className="space-y-4">
									...
									<p className="text-sm text-gray-600">
										Professional headshot captured
									</p>
								</div>
							</div>
							...
							<Alert className="bg-blue-50 border-blue-200">
								<AlertDescription className="text-blue-800">
									Your information is encrypted and secure. By
									submitting, you confirm all details are
				...
				return (
					<Card className="bg-gradient-to-br from-green-50 to-emerald-100 border-0 shadow-xl">
						<CardHeader className="text-center pb-8">
							...
							<CardDescription className="text-lg text-gray-600 max-w-2xl mx-auto">
								Your professional identity verification is being
								processed. You'll receive notification once
								completed, typically within 24-48 hours.
							</CardDescription>
						</CardHeader>
						<CardContent className="space-y-6">
							...
							<div className="text-center">
								...
								<p className="text-gray-500 text-sm mt-4">
									You can browse the platform while your
			...
			<div className="container mx-auto px-4 max-w-4xl">
				...
				<div className="text-center mb-12">
					...
					<p className="text-xl text-gray-600 max-w-2xl mx-auto">
						Secure your identity with our enterprise-grade
						verification process
					</p>
				</div>
				...
				<div className="text-center mt-8">
					<div className="flex items-center justify-center gap-2 text-gray-500 text-sm">
						...
						<span>
							Bank-level security • Encrypted transmission • GDPR
							compliant
						</span>
					</div>
				</div>
